...
//
//
//   //loop this while openSet has something in it
//
//   var current = start;
...
//     console.log(current);
//     //adds neighbors to openSet, updates their parents and values
//     for (var i = 0; i < current.neighbors.length; i++) {
//       var neighbor = grid[current.neighbors[i].row][current.neighbors[i].column];
//       if (!openSet.includes(neighbor)) {
//         //update g of neighbors
//         neighbor.gValue = current.gValue + findGForNeighbor(current, neighbor);
//         console.log(neighbor.gValue);
//         neighbor.calcF();
...
//move current node to closed set and remove from open set
//find current nodes neighbors
//  push to open set
//  assign current as parent
//  find g and f values for all neighbors
//
